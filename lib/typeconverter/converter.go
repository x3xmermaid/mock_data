...
// GetNumberFloat64 function to convert other type data to float64
func GetNumberFloat64(val interface{}) (float64, error) {
	switch val.(type) {
	case nil:
		return 0, nil
	case json.Number:
...
// GetNumberInt64 function to convert other type data to int64
func GetNumberInt64(val interface{}) (int64, error) {
	switch val.(type) {
	case nil:
		return 0, nil
	case json.Number:
...
// RoundInterval return rounded time
